...
| "How do I use real Plum data" | Claude lists what's available, shows you the columns, and runs a sample query. It's a frozen, de-identified snapshot — safe to explore, not safe to publish (see below). |
